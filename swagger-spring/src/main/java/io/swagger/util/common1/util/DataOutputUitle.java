...
import io.swagger.util.common1.util.newbean.OutputStringParser;
import io.swagger.util.common1.util.newbean.PortalApp;
import io.swagger.util.common1.util.newbean.PortalStruct;
import io.swagger.util.common1.util.newbean.PortalSubstanceParseXml;

public class DataOutputUitle {
	public static boolean htmlparser(String path, PortalApp pa, PortalStruct ps, IResourcesDao resourcedao,
			IResourceDataDao datadao) {
		...
		if (!paserFile(html, "<!--mainMenu-start-->", "<!--mainMenu-end-->", menu))
			return false;

		String hb = OutputStringParser.parseHB(resourcedao, datadao, path, hblist);
		if (!paserFile(html, "<!--movieList-start-->", "<!--movieList-end-->", hb))
			return false;
		...
		if (!paserFile(html, "<!--mainMenuMarqueeList-start-->", "<!--mainMenuMarqueeList-end-->", mianmar))
			return false;
		...
		if (!paserFile(html, "<!--subMenuMarqueeList-start-->", "<!--subMenuMarqueeList-end-->", submar))
			return false;
		...
		if (!paserFile(html, "<!--movieMarqueeList-start-->", "<!--movieMarqueeList-end-->", hbmar))
			return false;
		return true;
	}
	...
	public static void main(String[] asd) {
		/*
		 * String key1 = "name"; String[] value1 = {"123","222","333"}; String
		 * key2 = "info"; String[] value2 = {"123","222","333"}; String key3 =
		 * "all"; String[] one = new String[2]; String[] two = new String[2];
		 * two[0] = DataOutputUitle.getbaseJosn(key1, value1);
		 * //System.out.print(two[0]); two[1] =
		 * DataOutputUitle.getbaseJosn(key2, value2); one[0] =
		 * DataOutputUitle.getAppendJosn(two); System.out.println("---"+one[0]);
		 * one[1] = DataOutputUitle.getAppendJosn(two);
		 */
		// String contents = "movieList[0] = [{ name:\"\", pic:\"8_1.jpg\",
		// url:\"http://172.16.252.158:8080/PortalMangerService/index.htm?smid=\"+CAID
		// },{ name:\"\", pic:\"8_2.jpg\", url:\"ui://systemSetting.htm?3\"
		// }];";
		...
		System.out.println("完成" + path + start + end + contens + f);
