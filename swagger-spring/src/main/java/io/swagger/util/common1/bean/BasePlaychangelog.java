...
/**
 * This is an object that contains data related to the playchangelog table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="playchangelog"
 */
...
public abstract class BasePlaychangelog implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -813713094239946234L;
	 ...
	 */
	public BasePlaychangelog(java.lang.Integer id, User auditor, Vediotape vedioID, java.util.Date date) {
	 ...
	 *            the vedioID value
	 */
	public void setVedioID(Vediotape vedioID) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof Playchangelog))
			return false;
		else {
			Playchangelog playchangelog = (Playchangelog) obj;
			if (null == this.getId() || null == playchangelog.getId())
				return false;
			else
				return (this.getId().equals(playchangelog.getId()));
		}
	}
