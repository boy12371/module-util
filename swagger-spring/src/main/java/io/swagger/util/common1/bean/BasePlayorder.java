...
/**
 * This is an object that contains data related to the playorder table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="playorder"
 */
...
public abstract class BasePlayorder implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3728255011294346372L;
	 ...
	 */
	public BasePlayorder(java.lang.Integer id, User auditor, Vediotape vedioID, java.util.Date playDate,
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof Playorder))
			return false;
		else {
			Playorder playorder = (Playorder) obj;
			if (null == this.getId() || null == playorder.getId())
				return false;
			else
				return (this.getId().equals(playorder.getId()));
		}
	}
