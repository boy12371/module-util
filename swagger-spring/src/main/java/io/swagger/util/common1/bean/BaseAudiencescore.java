...
public abstract class BaseAudiencescore  implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4801842420946690176L;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof Audiencescore)) return false;
		else {
			Audiencescore audiencescore = (Audiencescore) obj;
