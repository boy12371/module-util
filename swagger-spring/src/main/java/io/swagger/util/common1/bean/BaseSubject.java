...
/**
 * This is an object that contains data related to the subject table. Do not
...
public abstract class BaseSubject implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1772408060286733319L;
	 ...
	 */
	public BaseSubject(java.lang.Integer id, java.lang.String subjectName, java.lang.Integer status,
	 ...
	 * 
	 * @hibernate.id generator-class="sequence" column="subjectID"
	 */
	...
	public void addTovediotapes(Vediotape vediotape) {
		if (null == getVediotapes())
			setVediotapes(new java.util.TreeSet<Vediotape>());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Subject))
			...
			if (null == this.getId() || null == subject.getId())
				return false;
			else
