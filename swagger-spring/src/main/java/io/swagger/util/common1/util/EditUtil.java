...
import io.swagger.util.common1.util.newbean.IPortalSubstanceDao;
import io.swagger.util.common1.util.newbean.IResourceDataDao;
import io.swagger.util.common1.util.newbean.IResourcesDao;
import io.swagger.util.common1.util.newbean.Item;
import io.swagger.util.common1.util.newbean.Menu;
import io.swagger.util.common1.util.newbean.MenuStruct;
import io.swagger.util.common1.util.newbean.MenuStructInner;
import io.swagger.util.common1.util.newbean.PortalApp;
import io.swagger.util.common1.util.newbean.PortalStruct;
import io.swagger.util.common1.util.newbean.PortalStructInner;
import io.swagger.util.common1.util.newbean.PortalSubstance;
import io.swagger.util.common1.util.newbean.Position;
import io.swagger.util.common1.util.newbean.Resource;
import io.swagger.util.common1.util.newbean.ResourceData;
import io.swagger.util.common1.util.newbean.ResourceItem;
import io.swagger.util.common1.util.newbean.ResourceList;
import io.swagger.util.common1.util.newbean.XmlParse;
...
public class EditUtil {
	 ...
	 * @return
	 */
	public static String updataPortalSubstance(int portalId, String resId, String resourceId,
			IPortalSubstanceDao psDao) {
	 ...
	 * @return
	 */
	// public static String getResourceData(String resourceDataXml,String
	// key,IResourcesDao resourceDao ){
	// String data = "";
	// //String resourceDataXml = new
	// String(Base64Fiend.decode(resourceDao.getResourceDataXml(resourceId)));
	//// logger.info(resourceDataXml);
	// ResourceData resourceData = (ResourceData)
	// XmlParse.parse(resourceDataXml, ResourceData.class);
	 ...
	 * @return
	 */
	public static String getResourceId(String portalStructXml, String portaAppXml, String onePosition,
			String position) {
		String haibao = position; // liuyh 修改
		/*
		 * if(position.equals("left")){ haibao = "haibao0"; }else
		 * if(position.equals("right")){ haibao = "haibao1"; }
		 */
