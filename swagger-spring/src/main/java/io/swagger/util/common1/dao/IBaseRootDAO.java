 ...
 * 
 */
package io.swagger.util.common1.dao;
...
public interface IBaseRootDAO {
	 ...
	 * @throws Exception
	 */
	// int getObjectTotalCountByFields(Class clz, String propertyName, Object
	 ...
	 * @throws Exception
	 */
	List findObjectByField(Class clz, String propertyName, Object value, int startIndex, int endIndex,
