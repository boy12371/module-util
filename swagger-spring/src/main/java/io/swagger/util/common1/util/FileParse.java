...
import io.swagger.util.common1.util.FileFiend;
import io.swagger.util.common1.domain.BankBillRecord;
import io.swagger.util.common1.domain.BankSignRecord;
import io.swagger.util.common1.domain.BankSignRecordBean;
import io.swagger.util.common1.domain.BankbillRecordBean;
...
public class FileParse {
	...
	public static void main(String[] args) {
		byte[] b=FileFiend.readFileByByte("c:/dd");
