...
import io.swagger.util.common1.common1.FileUtil;
import io.swagger.util.common1.common2.exception.NewspaperException;
...
public class DownServlet extends HttpServlet {
	...
	private void downloadModule(HttpServletRequest request, HttpServletResponse response) throws NewspaperException {
	...
	private void writeByteToFile(HttpServletResponse resp, String fileName, byte[] blobs) throws NewspaperException {
