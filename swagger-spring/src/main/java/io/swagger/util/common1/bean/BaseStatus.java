...
public abstract class BaseStatus implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1538997690582444346L;
	 ...
	 */
	public BaseStatus(java.lang.Integer id, java.lang.String status, java.lang.String comments) {
	 ...
	 * 
	 * @hibernate.id generator-class="sequence" column="statusID"
	 */
	...
	public void addToauditings(Auditing auditing) {
		if (null == getAuditings())
			setAuditings(new java.util.TreeSet<Auditing>());
