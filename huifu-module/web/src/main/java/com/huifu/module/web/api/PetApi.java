...
import com.huifu.module.web.model.ModelApiResponse;
import com.huifu.module.web.model.Pet;
...
public interface PetApi {
	...
	@RequestMapping(value = "/pet", produces = { "application/xml", "application/json" }, consumes = {
	...
	ResponseEntity<List<Pet>> findPetsByStatus(
			@ApiParam(value = "Status values that need to be considered for filter", required = true) @RequestParam(value = "status", required = true) List<String> status
	...
	ResponseEntity<List<Pet>> findPetsByTags(
			@ApiParam(value = "Tags to filter by", required = true) @RequestParam(value = "tags", required = true) List<String> tags
